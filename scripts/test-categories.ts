...
export const PRIMARY_TEST_CATEGORIES = {
  unit: [
    ...
    'scripts/stage5/genomeInitFixture.test.ts',
    ...
    'server/rustEngine/diskAdmission.test.ts',
    ...
    'src/stage4.sensorReference.test.ts',
  ...
  integration: [
    ...
    'server/rustEngine/checkpointPersistence.native.test.ts',
