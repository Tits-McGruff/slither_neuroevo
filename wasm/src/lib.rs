...
pub unsafe extern "C" fn gru_step(
    ...
    for b in 0..batch_count {
        ...
        for j in 0..hidden_size {
            ...
            sum_z += dense_dot(weights_ptr.add(uz_row), h_prev_ptr.add(state_base), hidden_size);
            sum_r += dense_dot(weights_ptr.add(ur_row), h_prev_ptr.add(state_base), hidden_size);
...
pub unsafe extern "C" fn lstm_step(
    ...
    for b in 0..batch_count {
        ...
        for j in 0..hidden_size {
            ...
            sum_i += dense_dot(weights_ptr.add(ui_row), h_prev_ptr.add(state_base), hidden_size);
            sum_f += dense_dot(weights_ptr.add(uf_row), h_prev_ptr.add(state_base), hidden_size);
            sum_o += dense_dot(weights_ptr.add(uo_row), h_prev_ptr.add(state_base), hidden_size);
            sum_g += dense_dot(weights_ptr.add(ug_row), h_prev_ptr.add(state_base), hidden_size);
...
pub unsafe extern "C" fn rru_step(
    ...
    for b in 0..batch_count {
        ...
        for j in 0..hidden_size {
            ...
            let mut sum_r = dense_dot(weights_ptr.add(wr_row), input_ptr.add(input_base), in_size);
            sum_c += dense_dot(weights_ptr.add(uc_row), h_prev_ptr.add(state_base), hidden_size);
            sum_r += dense_dot(weights_ptr.add(ur_row), h_prev_ptr.add(state_base), hidden_size);
