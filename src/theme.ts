...
export const THEME = {
  ...
  // Robot Bot Theme
  snakeRobotBody: "#C0C0C0",
  snakeRobotEye: "#ff0000",
  snakeRobotGlow: "#00ffff",
};
...
export function getPelletColor(p: {
  ...
  switch (p.kind) {
    case "boost":
      return THEME.pelletBoost;
    case "corpse_big":
    case "corpse_small":
      return THEME.pelletCorpse;
    default:
      return THEME.pelletAmbient;
  }
}
...
export function getPelletGlow(p: {
  ...
  switch (p.kind) {
    case "boost":
      return THEME.glowBoost;
    case "corpse_big":
    case "corpse_small":
      return THEME.glowCorpse;
    default:
      return THEME.glowAmbient;
  }
}
